...
lib = CDLL("/home/hts/darknet/libdarknet.so", RTLD_GLOBAL)
...
class yolo_detect:
    def __init__(self, img_path, cfg_path = '/home/hts/darknet/cfg/yolov2-voc.cfg', 
                        weight_path = '/home/hts/Documents/darknet_backup/yolov2-voc_900.weights', meta_path = '/home/hts/darknet/cfg/voc.data'):
        self.net = load_net(cfg_path, weight_path, 0)
        self.im = load_image(img_path, 0, 0)
        self.meta = load_meta(meta_path)
        self.frame_name = img_path
    def detect(self, net, meta, image, thresh=.5, hier_thresh=.5, nms=.45):
        ...
        res = sorted(res, key=lambda x: -x[1]) #按照key来排序， res的第二位数据的负数
        free_image(im)
    ...
    def detect_pic(self):
        r = self.detect(self.net, self.meta, self.frame_name)
        print r
        if r == "none":
            return "none"
...
if __name__ == "__main__":
    my_detector = yolo_detect('/home/hts/Pictures/my_pic_darknet/37.jpg')
    my_detector.detect_pic()
